...
<body class="bg-putih-200 flex flex-col justify-center items-center min-h-screen">
    <lottie-player id="lottieAnimation" class="mb-6 w-[128px] h-[116px]"
        src="{{ asset('asset/json/lottieflow-success-02-075733-easey.json') }}" background="transparent" speed="0.8"
        autoplay>
    </lottie-player>
